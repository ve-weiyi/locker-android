...
import com.ve.lib_api.model.room.AppDatabase;
import com.ve.lib_api.model.room.LatestDataDao;
...
import com.ve.lib_audio.mediaplayer.exception.AudioQueueEmptyException;
...
public class AudioController {
    ...
    private AudioController() {
        ...
        appDatabase = AppDatabase.Companion.getInstance(AudioHelper.getContext());
