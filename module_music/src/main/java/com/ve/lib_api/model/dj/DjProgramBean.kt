package com.ve.lib_api.model.dj
...
class DjProgramBean {
    ...
    var code = 0
    var isMore = false
    var programs: List<ProgramsBean>? = null
    ...
    class ProgramsBean {
         ...
         * commentCount : 57
         */
        var mainSong: MainSongBean? = null
        var songs: Any? = null
        var dj: DjBean? = null
