 ...
 * @Date 2022/4/10
 */
class UserPrivacyInfoPassAdapter:
    BaseSlideBindingAdapter<UserPrivacyInfoPassVO, LockerItemPrivacyAccountBinding>() {

    override fun convert(holder: VBViewHolder<LockerItemPrivacyAccountBinding>, item: UserPrivacyInfoPassVO) {
